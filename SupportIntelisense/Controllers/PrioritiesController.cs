...
namespace SupportIntelisense.Controllers
{
    public class PrioritiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PriorityId,Priority_Name")] Priority priority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("PriorityId,Priority_Name")] Priority priority)
        {
