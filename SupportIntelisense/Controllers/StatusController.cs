...
namespace SupportIntelisense.Controllers
{
    public class StatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StatusId,Status_Name")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("StatusId,Status_Name")] Status status)
        {
